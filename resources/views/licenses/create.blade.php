...
<div class="p-4 sm:ml-64 mt-16">
    <div class="bg-white rounded-xl shadow-lg p-8 w-full">
        <div class="mb-8 flex flex-wrap gap-4 items-center justify-between border-b pb-4">
            <div>
                <h2 class="text-2xl font-bold text-gray-800">Créer une Nouvelle Licence</h2>
                <p class="text-gray-600 mt-1">Générez et configurez une nouvelle licence pour vos clients</p>
            </div>
        ...
        <form action="{{ route('licenses.store') }}" method="POST" class="space-y-6">
            ...
            <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                ...
                <p class="mt-2 text-sm text-gray-600">Ajoutez tous les domaines autorisés à utiliser cette licence</p>
            </div>
